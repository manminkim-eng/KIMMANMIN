...
# GitHub Pages 배포 경로 (KIMMANMIN 저장소 하위 law 폴더 기준)
CANON = "https://manminkim-eng.github.io/KIMMANMIN/law/"
...
function syncInstallBtn(){
  ...
  if(isStandalone()||window.__installed){ b.classList.remove('on'); }
